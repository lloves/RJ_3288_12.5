...
public class EvRebootPreferenceController extends AbstractPreferenceController
        implements PreferenceControllerMixin {
    /** Key of the "Factory reset" preference in {@link R.xml.reset_dashboard_fragment}. */
    private static final String KEY_FACTORY_RESET = "ev_reboot_reset";

    private final UserManager mUm;

    public EvRebootPreferenceController(Context context) {
        super(context);
